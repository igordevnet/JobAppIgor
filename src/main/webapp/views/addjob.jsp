...
<%@ page import="com.firstproject.jobappigor.model.JobPost" %>
	...
	<title>Igorzera Job Portal</title>
	<link
	...
	<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav ms-auto">
						...
						<li class="nav-item"><a class="nav-link" href="https://www.linkedin.com/in/igor-souza-de-almeida-1857b02b8/">Contact</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<%
		    JobPost mvJobPost = (JobPost) request.getAttribute("jobPost");
		%>
